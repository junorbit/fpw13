...
public class GameManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        InvokeRepeating("SpawnEnemyTwo", 1f, 2f);
    ...
    void Update()
    {
        ...
        {
            Instantiate(thingsThatSpawn[2], new Vector3(Random.Range(-7f, 7f), Random.Range(0, -5f), 0), Quaternion.identity);
        }
    }
    ...
    void SpawnEnemyTwo()
    {
        Instantiate(enemyTwoPrefab, new Vector3(Random.Range(-8, 8), 7.5f, 0), Quaternion.Euler(0, 0, 180));
    }
